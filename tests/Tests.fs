...
let createHost() =
    WebHostBuilder()
        ...
        .Configure(Action<IApplicationBuilder> GiraffeAngularTemplate.App.configureApp)
        .ConfigureServices(Action<IServiceCollection> GiraffeAngularTemplate.App.configureServices)
